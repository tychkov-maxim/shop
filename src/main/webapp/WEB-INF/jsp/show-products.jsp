        ...
        <div class="container-fluid">
            ...
            <ul class="pager">
                <c:if test="${not empty previousPage}">
                    <li>
                        <a href="${pageContext.request.contextPath}/show.do?page=${previousPage}&category=${param.category}"><fmt:message
                                key="previous"/> </a>
                    </li>
                </c:if>
                <c:if test="${not empty nextPage}">
                    <li>
                        <a href="${pageContext.request.contextPath}/show.do?page=${nextPage}&category=${param.category}"><fmt:message
                                key="next"/></a>
                    </li>
                </c:if>
            </ul>
