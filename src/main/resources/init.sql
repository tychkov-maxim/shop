...
(
  ...
  CONSTRAINT ORDERS_USERS_ID_FK FOREIGN KEY (ID) REFERENCES USERS (ID)
);
...
(
  ...
  QUANTITY INTEGER NOT NULL,
  CONSTRAINT CARTS_PRODUCT_ID_CART_ID_PK PRIMARY KEY (PRODUCT_ID, CART_ID),
  CONSTRAINT CARTS_ORDERS_ID_FK FOREIGN KEY (CART_ID) REFERENCES ORDERS (ID)
);
CREATE INDEX CARTS_ORDERS_ID_FK_INDEX_3 ON CARTS (CART_ID);
