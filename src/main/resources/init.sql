...
(
  ...
  CONSTRAINT PRODUCT_CATEGORIES_CATEGORY_ID_PRODUCT_ID_PK PRIMARY KEY (CATEGORY_ID, PRODUCT_ID),
...
CREATE INDEX PRODUCT_CATEGORIES_CATEGORIES_ID_FK_INDEX_5 ON PRODUCT_CATEGORIES (CATEGORY_ID);
CREATE INDEX PRODUCT_CATEGORIES_PRODUCTS_ID_FK_INDEX_5 ON PRODUCT_CATEGORIES (PRODUCT_ID);
